...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $testerspeciality = $_POST["testerspeciality"];

    $sql = "INSERT INTO tester (tester_name , tester_specialization) VALUES ('".$testerName."','".$testerspeciality."')";
...
<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="tester.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Add Tester</a>
                ...
                <div class="form-container add_product charts">
                    ...
                    <form action="#" method="POST">
                        <div class="form-group">
                            <label for="productName">Tester Name</label>
                            <input type="text" id="productName" name="testerName" class="form-control" required>
                        ...
                        <select class="form-select" id="floatingSelect" aria-label="Floating label select example"
                                name="testerspeciality" autocomplete="off">
