                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="charts user_table text-center bg-light rounded h-100 p-4">
                            <h6 class="mb-4">SRS User Table</h6>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
...
<tr>
    ...
    <td>
        <button class="btn table_btn_edit">
            <a href="edit.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Are you sure')">Edit</a>
        </button>
    </td>
    <td>
        <button class="btn table_btn_del">
