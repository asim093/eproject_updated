...
<body>
    ...
    <div class="collapse navbar-collapse text-center bg-white nav_item" id="navbarCollapse">
      <div class="navbar-nav ms-auto">
        ...
        <a href="http://localhost/eproject/website/service.php" class="nav-item nav-link active">Service</a>
            ...
            <div class="col-lg-5 service-item wow zoomIn" data-wow-delay="0.9s">
              ...
              >
                ...
                <p class="text-white mb-3">
                  "To schedule an appointment with our expert electricians, simply fill out the appointment form on our website."
                </p>
